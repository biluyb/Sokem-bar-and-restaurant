...
import { Utensils, Calendar, Wine, Check, X, Shield, RefreshCw } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        ...
        <div className="flex items-center gap-3">
          <Badge variant="gold">Branch: Flagship Lounge</Badge>
          <span className="text-xs text-slate-400">Role: Manager</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <Card className="p-6">
          ...
          <div className="font-heading text-3xl font-bold text-white mt-2">12 Guests</div>
        ...
        <Card className="p-6">
          ...
          <div className="font-heading text-3xl font-bold text-white mt-2">3 Scheduled</div>
