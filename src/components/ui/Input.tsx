    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "w-full px-4 py-2.5 rounded-lg bg-slate-900/90 border border-slate-700 text-slate-100 placeholder-slate-500",
            "focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-colors duration-200",
